...
function modernize(html) {
  let result = html
    ...
    .replace('<link rel="icon" href="/assets/budmates-favicon.jpg" type="image/jpeg">', '<link rel="icon" href="/assets/budmates-favicon.jpg" type="image/jpeg"><link rel="preconnect" href="https://app.reai.no" crossorigin>')
    .replace(/<link rel="stylesheet" href="\/assets\/store\.css(?:\?v=\d+)?">/g, '<link rel="stylesheet" href="/assets/store.css?v=4">')
    .replace(/<script(?: type="module")? src="\/assets\/store\.js\?v=\d+"(?: defer)?><\/script>/g, '<script type="module" src="/assets/store.js?v=11"></script>')
