...
function modernize(html) {
  let result = html
    ...
    .replace(/<script src="\/assets\/store\.js\?v=\d+" defer><\/script>/g, '<script src="/assets/store.js?v=10" defer></script>')
  ...
  if (!result.includes('<meta name="color-scheme"')) {
    result = result.replace('<meta name="viewport" content="width=device-width,initial-scale=1">', '<meta name="viewport" content="width=device-width,initial-scale=1"><meta name="color-scheme" content="dark light">');
  }
  if (!result.includes('<link rel="preconnect" href="https://app.reai.no" crossorigin>')) {
    result = result.replace('<link rel="icon" href="/assets/favicon.svg" type="image/svg+xml">', '<link rel="icon" href="/assets/favicon.svg" type="image/svg+xml"><link rel="preconnect" href="https://app.reai.no" crossorigin>');
  }
