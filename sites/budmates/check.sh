...
grep -q 'store.js?v=11' storefront.mjs
grep -q 'store.css?v=4' storefront.mjs
grep -q 'store.js?v=11' public/search/index.html
grep -q 'store.css?v=4' public/search/index.html
