...
grep -q 'data-market-select' "$site_dir/public/index.html"
grep -q 'value=norway selected' "$site_dir/public/nb/index.html"
grep -q 'value=international selected' "$site_dir/public/index.html"
