...
- Public checkout stays disabled until Adyen, shipping, terms, and an end-to-end order are verified. The review preview allows code-gated checkout testing while those launch checks are in progress.
